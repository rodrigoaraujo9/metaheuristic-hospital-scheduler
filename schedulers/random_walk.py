    ...
    def run(self):
        ...
        for i in range(self.iterations):
            ...
            if (i+1) % 100 == 0:
                ...
                # Apply a guided move towards earlier admissions occasionally
                if (i+1) % 200 == 0:
                    # Focus on scheduling patients on their earliest possible day
                    for patient in current_solution:
                        if random.random() < 0.3:  # 30% chance per patient
