...
if page == "Single Algorithms" :
    ...
    def get_scheduler(algorithm, instance_data):
        ...
        Available algorithms: 'sa' (Simulated Annealing), 'hybrid_sa' (Hybrid Simulated Annealing), 
