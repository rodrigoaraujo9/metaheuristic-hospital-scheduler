        ...
        for ward in compatible_wards:
            ...
            for day in range(
                ...
                if can_fit:
                    ...
                    # Considerar cirurgias no dia e preferência para especialidade principal
                    ...
                    total_score = surgery_score + spec_penalty + day_penalty
...
def calculate_cost(instance_data, solution):
    ...
    """
    # Pesos para os diferentes componentes do custo
    # Ajustar estes valores pode levar a diferentes balanços de objetivos
...
def make_neighbor_solution(instance_data, current_solution, strategy="mixed"):
    ...
    if strategy == "mixed":
        strategy = random.choice(["ward", "day", "both", "smart"])
